      ...
      <div className="overflow-x-auto">
        <table className="mt-4 w-full">
          <thead className="bg-[#344d7aed] text-xs text-white">
            <tr>
              <th className="p-2 text-center font-normal">Username</th>
              <th className="p-2 text-center font-normal">Processed By</th>
              <th className="p-2 text-center font-normal">Type</th>
            </tr>
          </thead>
          <tbody>
